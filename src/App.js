...
class App extends Component {
  ...
  render() {
    ...
    return (
      <div className="App">
        <p>Picture:</p>
          <input value =  {this.state.pictureInput}onChange ={(e) =>this.pictureChange(e.target.value)}/>
        <p>Name:</p>
          <input value = {this.state.nameInput}onChange={(e) => this.nameChange(e.target.value)}/>
